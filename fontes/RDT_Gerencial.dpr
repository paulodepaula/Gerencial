...
uses
  ...
  xloc_cst_PC in 'fnts\xloc_cst_PC.pas' {frmxloc_cst_PC},
  ULote in 'fnts\ULote.pas' {FrmLote},
  UVendaCancelada in 'fnts\UVendaCancelada.pas' {FrmVCancelada},
  os in 'fnts\os.pas' {frmos},
  Os_Analise in 'fnts\Os_Analise.pas' {FrmOsAnalise},
  pre_venda in 'fnts\pre_venda.pas' {frmPre_Venda},
  funcoes in 'fnts\funcoes.pas',
  prevenda_conciliar in 'fnts\prevenda_conciliar.pas' {frmPrevenda_conciliar},
  senha_supervisor in 'fnts\senha_supervisor.pas' {frmSenha_Supervisor},
  menu_fiscal in 'fnts\menu_fiscal.pas' {frmMenu_Fiscal},
  uCliente in 'fnts\uCliente.pas',
  Ucnpf in 'fnts\Ucnpf.pas' {FrmCnpf},
  venda_cupom in 'fnts\venda_cupom.pas' {frmvenda_cupom},
  uFsist in 'fnts\uFsist.pas' {FrmFsist},
  venda_fechamento2 in 'fnts\venda_fechamento2.pas' {frmvenda_fechamento2},
  produto_venda in 'fnts\produto_venda.pas' {frmproduto_Venda},
  produto_pedidoVenda_item in 'fnts\produto_pedidoVenda_item.pas' {frmproduto_pedidoVenda_item},
  ecf_cupom in 'fnts\ecf_cupom.pas' {frmecf_cupom},
  URemessa in 'fnts\URemessa.pas' {FrmRemessa};

// Unit5 in 'fnts\metro\Unit5.pas' {metro_sair},
  //ACBrConsultaCPF in 'fnts\metro\CPF\ACBrConsultaCPF.pas',
  //UFrmConsCPF in 'fnts\metro\CPF\UFrmConsCPF.pas' {FrmConsCPF},
  //U_Principal in 'fnts\metro\CNPJ\U_Principal.pas' {F_Principal},
...
begin
 ...
 // Evita carga dupla da aplicacao
  {begin
    HprevHist := FindWindow(nil, PChar('Store_Protheus'));
    if HprevHist <> 0 then
    begin
      ShowMessage('O Sistema Store Protheus já está sendo executado em outra janela !');
      Application.Terminate;
      ShowWindow(HprevHist, SW_NORMAL);
      Exit;
    end;
  end; }
  Application.Title := 'RDTGerencial';

  Application.CreateForm(TfrmPrincipal, frmPrincipal);
  Application.CreateForm(TForm_ativar, Form_ativar);
  Application.CreateForm(Tfrmsplash, frmsplash);
  Application.CreateForm(Tfrmecf_cupom, frmecf_cupom);
