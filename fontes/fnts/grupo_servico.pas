...
uses
  ...
  ZAbstractRODataset, ZAbstractDataset, ZDataset, AdvMetroButton, Vcl.StdCtrls,
...
begin
  ...
  if qrgrupo_servico.state = dsinsert then qrgrupo_servico.fieldbyname('codigo').asstring := frmPrincipal.codifica('000012','update');
end;
