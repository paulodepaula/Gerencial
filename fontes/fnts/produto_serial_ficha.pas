...
uses
  ...
  DB, DBAccess, VirtualTable, RzEdit, RzBtnEdt, AdvGlowButton,
  ZAbstractRODataset, ZAbstractDataset, ZDataset, DBClient, JvExMask, JvToolEdit;
...
begin
  ...
  begin
    ...
    query.sql.add('(:codigo,:codproduto,:serial,:estoque,:precocusto,:situacao,');
    query.sql.add(':datacompra,:numeronota,:codfornecedor,:codnota)');
    query.parambyname('codigo').asstring := frmPrincipal.codifica('000022','update');
