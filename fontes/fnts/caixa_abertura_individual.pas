...
uses
  ...
  ZAbstractDataset, ZDataset, AdvGlowButton, AdvMetroButton, AdvSmoothPanel,
...
begin
  try
    ...
    begin
      ...
      frmcaixa.qrcaixa_mov.FieldByName('codigo').asstring := frmprincipal.codifica('000044','update');
