...
begin
  ...
  dbedit1.text := frmPrincipal.codifica('000037','ler');
...
begin
  ...
  begin
    ...
    begin
      ...
      frmmodulo.qrpedido_produto.fieldbyname('codigo').asstring := frmprincipal.codifica('000037','update');
...
begin
  ...
  qrpedido_item.fieldbyname('codigo').asstring :=
    frmprincipal.codifica('000038','update');
...
constructor TThread_showsql.Create(AOwner: TComponent);
begin
   inherited create(false);
end;

procedure TThread_showsql.Execute;
begin
  // panel_item.top := 375;
  // panel_item.left := 2;
  with  frmproduto_pedido do
  begin
    pgravar.visible := false;
