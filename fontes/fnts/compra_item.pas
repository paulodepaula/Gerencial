...
uses
  ...
  RzPanel, AdvMetroButton, AdvSmoothPanel,
  AdvSmoothExpanderPanel, System.ImageList, JvExMask, JvToolEdit, JvDBControls;
...
begin
  ...
  begin
    ...
    qrgrade_entrada.fieldbyname('codigo').asstring := frmPrincipal.codifica('000131','update');
  ...
  try
    ...
    begin
      ...
      begin
        ...
        frmmodulo.qrpreco.fieldbyname('codigo').asstring := frmprincipal.codifica('000026','update');
...

{
  ...
  begin
    ...
    begin
      ...
      FRMCOMPRA.qrnota_item.fieldbyname('codigo').asstring := frmprincipal.codifica('000032','update');
