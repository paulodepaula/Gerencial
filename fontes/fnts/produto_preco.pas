...
uses
  ...
  DBCtrls, DB, AdvGlowButton, RzEdit, ComCtrls, ZAbstractRODataset, ZAbstractDataset, ZDataset, Menus, JvExMask,
    ...
    begin
      ...
      begin
        ...
        while not query.Eof do begin
          ...
          begin
            query1.Insert;
            query1.fieldbyname('codigo').asstring := frmprincipal.codifica('000026','update');
