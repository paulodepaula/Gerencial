...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Mask, Menus, Buttons,
  ...
  System.ImageList, JvExMask, JvToolEdit;
...
begin
  ...
  frmmodulo.qrentrada_produto.fieldbyname('codigo').asstring := frmprincipal.codifica('000031','update');
  ...
  begin
    ...
    begin
      ...
      frmproduto_entrada.qrentrada_item.fieldbyname('codigo').asstring := frmprincipal.codifica('000032','update');
