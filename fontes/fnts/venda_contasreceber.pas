         ...
         begin
          ...
          while not frmmodulo.qrcondpgto_parcela.eof do
           begin
            ...
            frmvenda.qrvenda_contasreceber.fieldbyname('vencimento').asdatetime := strtodate(frmvenda.lvenda_data.caption) +
...
begin
  ...
  begin
    ...
    frmvenda_fechamento.rsoma.Value := acdinheiro + acchequeav + acchequeap + acctdeb +
                                       acctcrt + accarteira + acboleto + acconvenio;
