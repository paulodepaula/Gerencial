...
uses
  ...
  AdvSmoothExpanderPanel, JvBaseEdits, JvDBControls, JvExMask, JvToolEdit;
...
begin
  ...
  frmcontasreceber.qrcontasreceber.fieldbyname('codigo').asstring := frmprincipal.codifica('000049','update') + '/INC';
