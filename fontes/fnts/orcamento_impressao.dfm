object frmorcamento_impressao: Tfrmorcamento_impressao
  ...
  object AdvSmoothExpanderPanel1: TAdvSmoothExpanderPanel
    ...
    TMSStyle = 0
    OldHeight = 33.000000000000000000
  ...
  object fxorcamento: TfrxReport
    ...
    ReportOptions.LastChange = 43492.908027407400000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      
        '  Picture1.picture.loadfromfile('#39'c:\Store_Protheus\Server\img\lo' +
        'go.png'#39');                                                       ' +
        '                 '
      'end.')
    OnGetValue = fxorcamentoGetValue
    OnReportPrint = 'fxorcamentoOnReportPrint'
    Left = 424
    Top = 272
    Datasets = <
      item
        DataSet = frmOrcamento.fsorcamento
        DataSetName = 'fsorcamento'
      end
      item
        DataSet = frmOrcamento.fsorcamento_cliente
        DataSetName = 'fsorcamento_cliente'
      end
      item
        DataSet = frmOrcamento.fsorcamento_produto
        DataSetName = 'fsorcamento_produto'
      end
      item
        DataSet = frmOrcamento.fsorcamento_receber
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData2: TfrxMasterData
        ...
        DataSetName = 'fsorcamento_receber'
        RowCount = 0
        object fsorcamento_receberVENCIMENTO: TfrxMemoView
          Left = 3.779530000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsorcamento_receber."VENCIMENTO"]')
          ParentFont = False
        end
        object fsorcamento_receberVALOR: TfrxMemoView
          Left = 173.858380000000000000
          Top = 3.779530000000000000
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsorcamento_receber."VALOR"]')
          ParentFont = False
        end
        object fsorcamento_receberPRESTACAO: TfrxMemoView
          Left = 264.567100000000000000
          Top = 3.779530000000000000
          Width = 79.370130000000000000
          Height = 18.897650000000000000
  ...
  object qrvenda3: TZQuery
    ...
    object dtfldqrvenda3DATA: TDateField
      FieldName = 'DATA'
    end
  ...
  object ZQuery1: TZQuery
    ...
    object dtfldZQuery1DATA_CADASTRO: TDateField
    ...
    object dtfldZQuery1DATA_ULTIMACOMPRA: TDateField
    ...
    object dtfldZQuery1DATA_ULTIMAVENDA: TDateField
    ...
    object dtfldZQuery1DATA_ULTIMACOMPRA_ANTERIOR: TDateField
    ...
    object dtfldZQuery1DATA_REMARCACAO_CUSTO: TDateField
      FieldName = 'DATA_REMARCACAO_CUSTO'
    end
    object dtfldZQuery1DATA_REMARCACAO_VENDA: TDateField
      FieldName = 'DATA_REMARCACAO_VENDA'
    end
    object ZQuery1PRECO_PROMOCAO: TFloatField
      FieldName = 'PRECO_PROMOCAO'
    end
    object dtfldZQuery1DATA_PROMOCAO: TDateField
      FieldName = 'DATA_PROMOCAO'
    end
    object dtfldZQuery1FIM_PROMOCAO: TDateField
    ...
    object dtfldZQuery1ULTIMA_ALTERACAO: TDateField
      FieldName = 'ULTIMA_ALTERACAO'
    end
    object dtfldZQuery1ULTIMA_CARGA: TDateField
      FieldName = 'ULTIMA_CARGA'
    end
    object dtfldZQuery1DATA_INVENTARIO: TDateField
    ...
    object dtfldZQuery1DATA_INVENTARIO_ATUAL: TDateField
    ...
    object dtfldZQuery1LOTE_VALIDADE: TDateField
    ...
    object dtfldZQuery1ULTIMA_COMPRA: TDateField
      FieldName = 'ULTIMA_COMPRA'
    end
    object dtfldZQuery1FARMACIA_DATAVIGENCIA: TDateField
