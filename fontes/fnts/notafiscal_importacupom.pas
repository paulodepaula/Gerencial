...
uses principal, modulo, notafiscal, notafiscal_menu, RzDBEdit;
...
begin
  ...
  begin
    ...
    begin
      ...
      vnumero_inclui_nota := frmprincipal.codifica('000061','update'); //frmmodulo.qrnotafiscal.fieldbyname('codigo').asstring;
      ...
      while not query.Eof do begin
        ...
        begin
          ...
          frmnotafiscal.qrnotafiscal_item.FieldByName('CODIGO').ASSTRING := frmprincipal.codifica('000032','update');
