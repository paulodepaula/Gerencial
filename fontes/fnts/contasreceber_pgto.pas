...
var
  ...
  try
    ...
    begin
      ...
      begin
        frmcontasreceber.qrcontasreceber.FieldByName('VALOR_PAGO').ASfloat := frmcontasreceber.qrcontasreceber.FieldByName('VALOR_PAGO').ASfloat +
          rsoma.VALUE;
        frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat :=  STRTOFLOAT(formatfloat('########0.00',
          (frmcontasreceber.qrcontasreceber.FieldByName('valor_atual').ASfloat + rjuros.VALUE - rdesconto2.VALUE - rsoma.VALUE)));
      end;
      ...
      begin
        ...
        SQL.ADD('(codconta,data,valor_parcela,valor_juros,valor_desconto,valor_pago,'+
        'dinheiro,chequeav,chequeap,cartao,boleto,troco,credito,codcliente,caixa_banco)');
        SQL.ADD('values');
        SQL.ADD('(:codconta,:data,:valor_parcela,:valor_juros,:valor_desconto,:valor_pago,'+
        ':dinheiro,:chequeav,:chequeap,:cartao,:boleto,:troco,:credito,:codcliente,:caixa_banco)');
      ...
      begin
        ...
        begin
          ...
          FRMMODULO.QRCAIXA_MOV.FieldByName('codigo').asstring := frmPrincipal.codifica('000044','update');
          ...
          FRMMODULO.QRCAIXA_MOV.FieldByName('historico').asstring := 'Recebto. ' +
             nome_cliente + ' - Docto: ' + frmcontasreceber.qrcontasreceber.FieldByName('documento').asstring;
        ...
        begin
          ...
          begin
            ...
            FRMMODULO.QRCAIXA_MOV.FieldByName('movimento').ASINTEGER := 9;
            FRMMODULO.QRCAIXA_MOV.FieldByName('historico').asstring := 'Troco no Recebto. ' + nome_cliente + ' - Docto: ' +
        ...
        begin
          ...
          FRMMODULO.QRCAIXA_MOV.FieldByName('historico').asstring := 'Recebto. '+ nome_cliente + ' - Docto: ' +
          frmcontasreceber.qrcontasreceber.FieldByName('documento').asstring;
          FRMMODULO.QRCAIXA_MOV.post;
          if troco <> 0 then
          begin
    ...
    begin // apenas 01 conta
      ...
      begin
        ...
        frmcontasreceber.qrcontasreceber.FieldByName('DATA_PAGAMENTO').asdatetime := edata.DateTime;
        // frmmodulo.qrcaixa_operador.fieldbyname('data').asdatetime;
        frmcontasreceber.qrcontasreceber.FieldByName('filtro').ASINTEGER := 0;
        try
        frmcontasreceber.qrcontasreceber.post;
      ...
      begin
        ...
        begin
          ...
          frmcontasreceber.qrcontasreceber.FieldByName('codigo').asstring :=
            frmPrincipal.codifica('000049','update') + '/RE';
