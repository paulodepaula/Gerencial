...
uses
  ...
  frxDBSet, frxDesgn, Menus, Grids, DBGrids, AdvGlowButton, MemDS,
  DBAccess, RzButton, RzRadChk, AdvReflectionImage, AdvMetroButton,
...
type
  Tfrmlista_venda2 = class(TForm)
    ...
    dtfld_produto2VENCIMENTO: TDateField;
