...
uses
  ...
  dxCore, Grids, DBGrids, Db, Wwdatsrc, DBTables, Wwdbigrd, Wwdbgrid, Buttons, ZAbstractRODataset, ZAbstractDataset,
...
begin
  ...
  BEGIN
    ...
    begin
      qrgrade.close;
      qrgrade.SQL.clear;
      qrgrade.SQL.add('select * from c000021 where codproduto = ''' + frmmodulo.QRPRODUTO.FIELDBYNAME('codigo').ASSTRING +
                       ''' order by codigo');
      qrgrade.open;
