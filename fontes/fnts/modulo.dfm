object frmmodulo: Tfrmmodulo
  ...
  object qrconfig: TZQuery
    ...
    object intgrfldVENDA_FECHAMENTO_AVULSO: TIntegerField
      FieldName = 'VENDA_FECHAMENTO_AVULSO'
    end
  end
  ...
  object qrproduto: TZQuery
    ...
    object qrprodutoCST_NACIONAL: TWideStringField
      FieldName = 'CST_NACIONAL'
      Size = 3
    end
    object qrprodutoDATA_VENCIMENTO: TDateField
  ...
  object qrpreco: TZQuery
    ...
    object CDSosDATA_ALTERACAO: TDateField
  ...
  object qrreceita: TZQuery
    ...
    SQL.Strings = (
      'select * from c000024')
    Params = <>
    DataSource = frmPrincipal.dsempresa2
    Left = 212
    Top = 696
  end
  ...
  object qrcontasreceber: TZQuery
    ...
    object wdstrngfldCOD_OS_ORIGINAL: TWideStringField
      FieldName = 'COD_OS_ORIGINAL'
      Size = 15
    end
  end
  ...
  object qrorcamento: TZQuery
    ...
    object wdstrngfldSOLICITANTE: TWideStringField
      FieldName = 'SOLICITANTE'
      Size = 60
    end
  end
  ...
  object CDSos: TClientDataSet
    ...
    object CDSoscliente_celular: TStringField
      DisplayWidth = 20
      FieldKind = fkLookup
  ...
  object boleto: TACBrBoleto
    ...
    DirArqRemessa = 'C:\Store_Protheus\SERVER\cob\Remessa'
    DirArqRetorno = 'C:\Store_Protheus\SERVER\cob\Retorno'
    NumeroArquivo = 0
  ...
  object BoletoFR: TACBrBoletoFCFR
    ACBrBoleto = boleto
    DirLogo = 'C:\Store_Protheus\SERVER\img\Logos\Colorido'
    SoftwareHouse = 'Store Protheus'
    FastReportFile = 'C:\Store_Protheus\SERVER\rel\Boleto.fr3'
    ModoThread = False
  ...
  object qr_cstNacional: TZQuery
    ...
    Left = 864
    Top = 32
    object qr_cstNacionalCODIGO: TWideStringField
      FieldName = 'CODIGO'
      Size = 2
    end
    object qr_cstNacionalSITUACAO_TRIBUTARIA: TWideStringField
      FieldName = 'SITUACAO_TRIBUTARIA'
      Size = 100
    end
    object qr_cstNacionalENTRADA_SAIDA: TWideStringField
      FieldName = 'ENTRADA_SAIDA'
      Size = 1
    end
  end
  object qrSangrias: TZQuery
    Connection = Conexao
    SQL.Strings = (
      'select * from c000135')
    Params = <>
  ...
  object query_servidor: TZQuery
    Connection = Conexao
    Params = <>
    Left = 816
    Top = 624
  end
  object con2: TUniConnection
  ...
  object qrProduto_Venda: TZQuery
    Connection = Conexao
    SQL.Strings = (
      'select * from c000141')
    Params = <>
    Left = 890
    Top = 928
    object wdstrngfldProduto_VendaCODIGO: TWideStringField
      FieldName = 'CODIGO'
      Required = True
      Size = 6
    end
    object wdstrngfldProduto_VendaNUMERO: TWideStringField
      FieldName = 'NUMERO'
      Size = 6
    end
    object wdstrngfldProduto_VendaCFOP: TWideStringField
      FieldName = 'CFOP'
      Size = 5
    end
    object dtfldProduto_VendaDATA: TDateField
      FieldName = 'DATA'
    end
    object wdstrngfldProduto_VendaCODFORNECEDOR: TWideStringField
      FieldName = 'CODFORNECEDOR'
      Size = 6
    end
    object fltfldProduto_VendaTOTAL_NOTA: TFloatField
      FieldName = 'TOTAL_NOTA'
    end
    object intgrfldProduto_VendaITENS: TIntegerField
      FieldName = 'ITENS'
    end
    object intgrfldProduto_VendaSITUACAO: TIntegerField
      FieldName = 'SITUACAO'
    end
    object dtfldProduto_VendaPREVISAO: TDateField
      FieldName = 'PREVISAO'
    end
    object wdstrngfldProduto_VendaCONDPGTO: TWideStringField
      FieldName = 'CONDPGTO'
      Size = 50
    end
    object wdstrngfldProduto_VendaOBS1: TWideStringField
      FieldName = 'OBS1'
      Size = 80
    end
    object wdstrngfldProduto_VendaOBS2: TWideStringField
      FieldName = 'OBS2'
      Size = 80
    end
    object wdstrngfldProduto_VendaOBS3: TWideStringField
      FieldName = 'OBS3'
      Size = 80
    end
    object wdstrngfldProduto_VendaOBS4: TWideStringField
      FieldName = 'OBS4'
      Size = 80
    end
  end
  object QrM55: TZQuery
    Connection = Conexao
    SQL.Strings = (
      'Select Serie,numero from C000139'
      'where modelo = '#39'55'#39)
    Params = <>
    Left = 1124
    Top = 369
  end
