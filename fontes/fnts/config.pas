...
uses
  ...
  JvDBControls, JvExControls, JvButton, JvNavigationPane, NxDBColumns,
  NxColumns, NxDBGrid, NxScrollControl, NxCustomGridControl, NxCustomGrid,
  NxGrid, Datasnap.DBClient;
...
type
  Tfrmconfig = class(TForm)
    ...
    bt_config0004: TAdvGlowButton;
    bt_config0005: TAdvGlowButton;
    bt_config0006: TAdvGlowButton;
    bt_config0007: TAdvGlowButton;
    ...
    btBase: TAdvGlowButton;
    ZQuery1: TZQuery;
    ds1: TDataSource;
    NextDBGrid1: TNextDBGrid;
    advglwbtn1: TAdvGlowButton;
    dset: TClientDataSet;
    dbchkUSA_CAIXA_PADRAO_USUARIO: TDBCheckBox;
...
procedure Tfrmconfig.btBaseClick(Sender: TObject);
begin
PageView3.ActivePageIndex := 7;
end;
