...
uses modulo, principal, loc_regiao, regiao, loc_funci, loc_cliente,
  ...
  xloc_cheque, cheque_menu, venda_fechamento, venda_fechamento2;
...
begin
  ...
  frmmodulo.qrcheque.fieldbyname('codigo').asstring := frmprincipal.codifica('000040','update');
  frmmodulo.qrcheque.FIELDBYNAME('SITUACAO').ASSTRING := '1';
  frmmodulo.qrcheque.FIELDBYNAME('VALOR').asfloat := frmvenda_fechamento2.rchequeav.Value;
  frmmodulo.qrcheque.FIELDBYNAME('VENCIMENTO').AsDateTime :=  NOW;
