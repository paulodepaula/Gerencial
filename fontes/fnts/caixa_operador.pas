...
uses
  ...
  cyBaseSpeedButton, cySpeedButton, AdvSmoothTouchKeyBoard, AdvMetroButton,
...
begin
  ...
  begin
    ...
    frmmodulo.qrcaixa_operador.fieldbyname('codigo').asstring := frmprincipal.codifica('000045','update');
    pficha.Enabled := true;
    dbedit28.setfocus;
