object frmos: Tfrmos
    ...
    object PageSheet1: TPageSheet
      ...
      object gridservico: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'COMPLEMENTO'#9'49'#9'COMPLEMENTO'
          'DESC_PARCIAL'#9'10'#9'DESCONTO'
    ...
    object PageSheet2: TPageSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'CODVENDEDOR;CustomEdit;ComboVendedor;T')
        Selected.Strings = (
          'CODPRODUTO'#9'1'#9'C'#243'digo'#9#9
          'PRODUTO'#9'48'#9'PRODUTO'#9#9
          'SERIAL'#9'10'#9'SERIAL'#9#9
          'UNIDADE'#9'3'#9'UN'#9#9
          'UNITARIO'#9'10'#9'UNITARIO'#9#9
          'QTDE'#9'4'#9'QTDE'#9#9
          'TOTAL'#9'8'#9'TOTAL'#9#9
          'DESCONTO'#9'8'#9'DESC'#9#9
          'ACRESCIMO'#9'8'#9'ACRES'#9#9
          'CODVENDEDOR'#9'12'#9'CODVENDEDOR'#9#9
          'VENDEDOR'#9'20'#9'VENDEDOR'#9#9)
        IniAttributes.Delimiter = ';;'
        IniAttributes.UnicodeIniFile = False
        TitleColor = clBtnFace
        FixedCols = 0
      ...
      object ComboVendedor: TwwDBLookupComboDlg
        Left = 701
        Top = 203
        Width = 80
        Height = 21
  ...
  object qros_servico: TZQuery
    ...
    object fltfld_servicoDESC_PARCIAL: TFloatField
      DisplayLabel = 'DESCONTO'
      DisplayWidth = 10
      FieldName = 'DESC_PARCIAL'
    end
  ...
  object qros_produtos: TZQuery
    ...
    object qros_produtosVENDEDOR: TStringField
      DisplayWidth = 20
      FieldKind = fkLookup
      FieldName = 'VENDEDOR'
      LookupDataSet = frmmodulo.qrfunci
