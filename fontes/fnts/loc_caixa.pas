...
type
  Tfrmloc_caixa = class(TForm)
    ...
    wwDBGrid1: TwwDBGrid;
    wdstrngfld_operadorNOME: TWideStringField;
    wdstrngfld_operadorCODIGO: TWideStringField;
    wdstrngfld_operadorCODFUNCIONARIO: TWideStringField;
    wdstrngfld_operadorSENHA: TWideStringField;
    dtfld_operadorDATA: TDateField;
    intgrfld_operadorSITUACAO: TIntegerField;
    fltfld_operadorSALDO: TFloatField;
    wdstrngfld_operadorSITUACAO_ATUAL: TWideStringField;
...
begin
  ...
  qrcaixa_operador.SQL.Add('select b.nome,a.* from c000045 a, c000008 b'  +
