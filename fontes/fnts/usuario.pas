...
begin
 ...
 frmmodulo.qrUSUARIO.FieldByName('senha').asstring :=  frmmodulo.qrUSUARIO.FieldByName('senha').asstring;
...
begin
  ...
  frmmodulo.qrUsuario.FieldByName('codigo').asstring := frmprincipal.codifica('000003','update');
...
begin
 ...
 // frmmodulo.qrUSUARIO.FieldByName('senha').asstring := frmPrincipal.Cript('C', frmmodulo.qrUSUARIO.FieldByName('senha').asstring);
  frmmodulo.qrUSUARIO.FieldByName('senha').asstring :=  dbedit3.text;
