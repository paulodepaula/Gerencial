...
uses pre_venda, modulo, funcoes, principal;
...
procedure TfrmPrevenda_conciliar.FormCreate(Sender: TObject);
begin
dData_Sistema := Now;
end;
...
begin
  ...
  begin
    ...
    begin
      scod_cliente := zerarcodigo(grid_cliente.Cell[1,i].asstring,6);
      break;
    end;
  end;
  ...
  begin
    ...
    scod_conciliada := frmprincipal.codifica('000048','update'); //,6

    parambyname('codigo').asstring         := scod_conciliada;
    parambyname('data').asdatetime         :=  Now; //  dData_Sistema;
    ...
    begin
      ...
      begin
        ...
        parambyname('codigo').AsString := frmprincipal.codifica('000032','update'); //,6
        parambyname('codnota').AsString := scod_conciliada;
        parambyname('numeronota').AsString := scod_conciliada;
        parambyname('codproduto').asstring := zerarcodigo(grid_produto.cell[1,i].asstring,6);
        ...
        parambyname('codcliente').AsString := scod_cliente;
        parambyname('codvendedor').AsString := zerarcodigo(grid_produto.cell[7,i].asstring,6);
...
function TfrmPrevenda_conciliar.zerarcodigo(codigo: string;
  Qtde: Integer): string;
begin
