...
uses
  ...
  ZDataset, AdvGlowButton, AdvShapeButton, AdvOfficeHint, JvExMask, JvToolEdit,
  JvBaseEdits;
        ...
        frmmodulo.qrcaixa_mov.post;
          ...
          if rcrediario.value <= 0 then
            begin
              ...
              frmmodulo.qrcontasreceber.fieldbyname('data_pagamento').asstring := datetostr(date);
              ...
              frmmodulo.qrcontasreceber.fieldbyname('cod_os_original').asstring := FRMMODULO.cdsos.FIELDBYNAME('CODIGO').ASSTRING;
              frmmodulo.qrcontasreceber.fieldbyname('valor_atual').asfloat := 0;
              frmmodulo.qrcontasreceber.fieldbyname('documento').asstring := 'ENTRADA UNICA';
              frmmodulo.qrcontasreceber.fieldbyname('tipo').asstring := 'DINHEIRO A VISTA';
