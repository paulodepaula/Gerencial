...
uses
  ...
  Wwdbgrid, AdvGlowButton, wwdblook, Vcl.Imaging.jpeg, AdvMetroButton,
...
begin
  ...
  frmmodulo.qrcondpgto.fieldbyname('codigo').asstring := frmprincipal.codifica('000015','ler');
  pficha.Enabled := true;
  DBEdit2.setfocus;
...
begin
 ...
 //   frmmodulo.qrcondpgto.insert;
    frmmodulo.qrcondpgto.fieldbyname('codigo').asstring := frmprincipal.codifica('000015','update');
...
begin
  try
    ...
    frmmodulo.qrcondpgto_parcela.SQL.add('delete from c000016 where codcondpgto = ''' +
      frmmodulo.qrcondpgto.fieldbyname('codigo').asstring + '''');
    frmmodulo.qrcondpgto_parcela.ExecSQL;

    frmmodulo.qrcondpgto_parcela.SQL.clear;
    frmmodulo.qrcondpgto_parcela.SQL.add('select * from c000016 where codcondpgto = ''' +
      frmmodulo.qrcondpgto.fieldbyname('codigo').asstring +
      ''' order by numero');
    ...
    begin
      ...
      frmmodulo.qrcondpgto_parcela.fieldbyname('codigo').asstring :=
        frmprincipal.codifica('000016','update');
