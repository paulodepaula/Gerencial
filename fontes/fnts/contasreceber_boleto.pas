...
begin
  try
    numero_venda := frmprincipal.codifica('000048','update');
...
begin
  ...
  CobreBemX.PadroesBoleto.PadroesBoletoImpresso.CaminhoImagensCodigoBarras := 'c:\Store_Protheus\server\cob\CobreBemX\Imagens\';
