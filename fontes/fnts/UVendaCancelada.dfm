object FrmVCancelada: TFrmVCancelada
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'Cancelados'
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object SmPnlVCancel: TAdvSmoothExpanderPanel
    Left = 0
    Top = 0
    Width = 1098
    Height = 48
  ...
  object ControlVenda: TNxGlyphPageControl
    AlignWithMargins = True
    Left = 3
    Top = 51
    Width = 1092
    Height = 570
    ActivePage = TabSangrias
    ActivePageIndex = 2
    Align = alClient
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    ...
    object TabSangrias: TNxTabSheet
      ...
      object pnl1: TPanel
        ...
        object date1: TDateTimePicker
          ...
          Width = 97
          Height = 21
          Date = 43046.006832430550000000
          Time = 43046.006832430550000000
          TabOrder = 0
        end
    ...
    object TabCancelamento: TNxTabSheet
